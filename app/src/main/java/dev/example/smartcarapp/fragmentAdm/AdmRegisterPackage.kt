...
class AdmRegisterPackage : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View =  inflater.inflate(R.layout.fragment_adm_register_package, container, false)
        val btnPreviewView: Button = view.findViewById(R.id.btnRetornRegisterPackage)
